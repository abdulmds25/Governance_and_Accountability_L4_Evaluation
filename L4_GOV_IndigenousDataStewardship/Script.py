...
EVALUATION_PROMPT = """You are an AI governance and Indigenous data sovereignty expert. Evaluate the following documentation against the Governance Level 4 (L4_GOV_IndigenousDataStewardship) standard.

**Governance L4 Standard Definition:**
Indigenous data stewardship and consent mechanisms are in place. This includes:
1. Recognition of Indigenous data sovereignty and rights to self-determination
2. Implementation of CARE Principles (Collective Benefit, Authority to Control, Responsibility, Ethics) and/or OCAP® principles (Ownership, Control, Access, Possession)
3. Documented consent processes that respect Indigenous governance structures
4. Indigenous participation in data governance and decision-making
5. Evidence of culturally appropriate data practices and benefit-sharing arrangements
...
1. **Recognition of Indigenous Data Sovereignty**
   - Explicit acknowledgment of Indigenous data sovereignty and self-determination
   - Recognition of Indigenous peoples' rights over their data, knowledge, and cultural heritage
   - Reference to relevant frameworks (UN Declaration on Rights of Indigenous Peoples, CARE, OCAP®)
   - Acknowledgment of diverse Indigenous nations and their distinct governance systems
   - Commitment to respectful partnerships and relationship-building

2. **CARE/OCAP® Principles Implementation**
   - Application of CARE Principles: Collective Benefit, Authority to Control, Responsibility, Ethics
   - Application of OCAP® Principles: Ownership, Control, Access, Possession (if relevant to First Nations)
   - Documentation of how data benefits Indigenous communities
   - Mechanisms ensuring Indigenous authority over data use and access
   - Ethical obligations and accountability structures described

3. **Consent Processes and Protocols**
   - Free, Prior, and Informed Consent (FPIC) protocols documented
   - Consent processes respect Indigenous governance structures and decision-making timelines
   - Culturally appropriate consent mechanisms described
   - Ongoing consent and right to withdraw clearly established
   - Community-level vs individual consent considerations addressed
   - Documentation in appropriate languages and formats

4. **Indigenous Participation and Leadership**
   - Indigenous representation in data governance bodies
   - Indigenous leadership roles in decision-making processes
   - Co-design and co-governance approaches documented
   - Indigenous advisors, councils, or review boards established
   - Mechanisms for Indigenous community input and feedback
   - Capacity building and resource allocation for Indigenous participation

5. **Culturally Appropriate Data Practices**
   - Data collection methods respect cultural protocols and sensitivities
   - Protection of sacred, ceremonial, or culturally sensitive information
   - Consideration of Traditional Knowledge and Intellectual Property
   - Appropriate data aggregation/disaggregation practices
   - Return of data and research results to communities
   - Cultural safety training for staff working with Indigenous data

6. **Benefit-Sharing and Accountability**
   - Clear benefit-sharing arrangements with Indigenous communities
   - Mechanisms for Indigenous communities to derive value from their data
   - Accountability measures for adherence to agreements
   - Regular review and renegotiation processes with communities
   - Transparency in data use and outcomes reporting
   - Dispute resolution mechanisms that respect Indigenous processes
   - Remediation procedures for violations of agreements
...
{{
  ...
  "criteria_scores": {{
    "indigenous_sovereignty_recognition": {{"score": X, "evidence": "...", "gaps": "..."}},
    "care_ocap_implementation": {{"score": X, "evidence": "...", "gaps": "..."}},
    "consent_processes": {{"score": X, "evidence": "...", "gaps": "..."}},
    "indigenous_participation": {{"score": X, "evidence": "...", "gaps": "..."}},
    "culturally_appropriate_practices": {{"score": X, "evidence": "...", "gaps": "..."}},
    "benefit_sharing_accountability": {{"score": X, "evidence": "...", "gaps": "..."}}
  }},
