...
EVALUATION_PROMPT = """You are an AI governance and child safety expert. Evaluate the following documentation against the Governance Level 4 (L4_GOV_ChildSafetyEscalation) standard.

**Governance L4 Standard Definition:**
Law-enforcement escalation SLAs (Service Level Agreements) for child safety are in place. This includes:
1. Clear protocols for identifying child safety risks and CSAM (Child Sexual Abuse Material)
2. Documented escalation procedures to law enforcement
3. Defined Service Level Agreements with specific timeframes for escalation
4. Established relationships and communication channels with law enforcement agencies
5. Evidence of implementation, training, and regular review of escalation procedures
...
1. **Child Safety Risk Identification**
   - Clear definition of child safety risks and CSAM
   - Detection mechanisms and monitoring systems described
   - Content moderation policies specific to child safety
   - Risk assessment frameworks documented
   - Proactive vs reactive detection approaches specified

2. **Escalation Protocols and Procedures**
   - Step-by-step escalation procedures documented
   - Clear triggers for law enforcement escalation defined
   - Chain of command and decision-making authority specified
   - Emergency escalation procedures for imminent threats
   - Documentation and evidence preservation protocols

3. **Service Level Agreements (SLAs)**
   - Specific timeframes for escalation to law enforcement stated
   - Response time commitments for different severity levels
   - SLA metrics and performance indicators defined
   - Consequences for missing SLA targets specified
   - Regular SLA review and update processes described

4. **Law Enforcement Relationships**
   - Established partnerships with relevant law enforcement agencies documented
   - Communication channels and contact protocols specified
   - Jurisdictional considerations addressed (local, national, international)
   - Information sharing agreements and legal frameworks referenced
   - Regular coordination meetings or joint training mentioned

5. **Implementation and Training**
   - Staff training on child safety protocols documented
   - Training content covering legal obligations and escalation procedures
   - Target audiences specified (content moderators, trust & safety, legal, leadership)
   - Frequency of training and certification requirements mentioned
   - Examples of past escalations or case studies referenced

6. **Monitoring, Reporting, and Compliance**
   - Regular audits of escalation procedures described
   - Performance metrics and reporting mechanisms
   - Transparency reports on child safety incidents published
   - Compliance with legal requirements (NCMEC reporting, international obligations)
   - Continuous improvement processes and incident post-mortems
   - External oversight or third-party validation referenced
...
{{
  ...
  "criteria_scores": {{
    "risk_identification": {{"score": X, "evidence": "...", "gaps": "..."}},
    "escalation_protocols": {{"score": X, "evidence": "...", "gaps": "..."}},
    "service_level_agreements": {{"score": X, "evidence": "...", "gaps": "..."}},
    "law_enforcement_relationships": {{"score": X, "evidence": "...", "gaps": "..."}},
    "implementation_training": {{"score": X, "evidence": "...", "gaps": "..."}},
    "monitoring_compliance": {{"score": X, "evidence": "...", "gaps": "..."}}
  }},
